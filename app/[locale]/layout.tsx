...
export default async function LocaleLayout({
  ...
  const structuredData = {
    ...
    serviceType: locale === 'ru' 
      ? ['Cleaning Service', 'Клининговые услуги', 'Уборка домов', 'Офисная уборка', 'Глубокая уборка', 'Чистка ковров']
      : ['Cleaning Service', 'Tozalash xizmatlari', 'Uy tozalash', 'Ofis tozalash', 'Gilam tozalash'],
    inLanguage: locale,
  };
