        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><a href="#services" className="hover:text-foreground transition-colors">{t('residential')}</a></li>
              <li><a href="#services" className="hover:text-foreground transition-colors">{t('commercial')}</a></li>
              <li><a href="#services" className="hover:text-foreground transition-colors">{t('deepCleaning')}</a></li>
              <li><a href="#services" className="hover:text-foreground transition-colors">{t('specialized')}</a></li>
            </ul>
          </div>
